 ...
 */
import { VERSION } from "./nape-js.esm.js?v=3.17.0";
...
import carSideview    from "./demos/car-sideview.js?v=3.17.0";
import carTopdown     from "./demos/car-topdown.js?v=3.17.0";
import platformer     from "./demos/platformer.js?v=3.17.0";
import ropeBridge     from "./demos/rope-bridge.js?v=3.17.0";
import wreckingBall   from "./demos/wrecking-ball.js?v=3.17.0";
import newtonsCradle  from "./demos/newtons-cradle.js?v=3.17.0";
import dominos        from "./demos/dominos.js?v=3.17.0";
import conveyorBelts  from "./demos/conveyor-belts.js?v=3.17.0";
import trebuchet      from "./demos/trebuchet.js?v=3.17.0";
import seesaw         from "./demos/seesaw.js?v=3.17.0";
import pinball        from "./demos/pinball.js?v=3.17.0";
import cloth          from "./demos/cloth.js?v=3.17.0";
import funnel         from "./demos/funnel.js?v=3.17.0";
import softBody       from "./demos/soft-body.js?v=3.17.0";
import oneWayPlatforms from "./demos/one-way-platforms.js?v=3.17.0";
import collisionFiltering from "./demos/collision-filtering.js?v=3.17.0";
import bodyFromGraphic    from "./demos/body-from-graphic.js?v=3.17.0";
import dropImageBody     from "./demos/drop-image-body.js?v=3.17.0";
import capsule           from "./demos/capsule.js?v=3.17.0";
import destructibleTerrain from "./demos/destructible-terrain.js?v=3.17.0";
import webWorker           from "./demos/web-worker.js?v=3.17.0";
import asteroidField       from "./demos/asteroid-field.js?v=3.17.0";
import fluidBuoyancy       from "./demos/fluid-buoyancy.js?v=3.17.0";
import deterministic       from "./demos/deterministic.js?v=3.17.0";
import subStepping         from "./demos/sub-stepping.js?v=3.17.0";
